...
export const UsersIcon = ({ className = "w-5 h-5 md:w-[20px] md:h-[20px]" }) => (
  <svg className={className} fill="none" stroke="#7C3AED" strokeWidth="1.8" viewBox="0 0 24 24">
...
export const MapPinIcon = ({ className = "w-5 h-5 md:w-[20px] md:h-[20px]" }) => (
  <svg className={className} fill="none" stroke="#059669" strokeWidth="1.8" viewBox="0 0 24 24">
    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" />
    <circle cx="12" cy="10" r="3" />
  </svg>
);

export const PhoneCallIcon = ({ className = "w-5 h-5 md:w-[20px] md:h-[20px]" }) => (
  <svg className={className} fill="none" stroke="#EA580C" strokeWidth="1.8" viewBox="0 0 24 24">
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.35 2 2 0 0 1 3.58 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.56a16 16 0 0 0 6.09 6.09l1.62-.96a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z" />
    <polyline points="23 7 16 14 13 11" />
  </svg>
);

export const CheckSquareIcon = ({ className = "w-5 h-5 md:w-[20px] md:h-[20px]" }) => (
  <svg className={className} fill="none" stroke="#6366F1" strokeWidth="1.8" viewBox="0 0 24 24">
