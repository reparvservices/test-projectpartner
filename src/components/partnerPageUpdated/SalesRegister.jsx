  ...
  return (
      ...
      >
        ...
        <div className="rounded-t-3xl bg-gradient-to-r from-purple-700 to-purple-500 p-6 text-white text-center">
          ...
          <p className="text-sm text-purple-100 mt-1">
            Join our professional sales network
          </p>
        </div>
        ...
        <div className="p-0 sm:p-6 sm:p-8 space-y-6">
          ...
          <Section title="Personal Information">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Input
                ...
                onChange={(v) =>
                  setNewPartner({ ...newPartner, fullname: v })
                }
              />
              <Input
                label="Phone Number"
          ...
          <Section title="Location Details">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Select
                ...
                onChange={(v) =>
                  setNewPartner({ ...newPartner, state: v })
                }
              ...
              <Select
                ...
                onChange={(v) =>
                  setNewPartner({ ...newPartner, city: v })
                }
          ...
          <Section title="Account Credentials">
            <Input
              ...
              onChange={(v) =>
                setNewPartner({ ...newPartner, username: v })
              }
            />
          ...
          <Section title="Additional Information">
            <Select
              ...
              onChange={(v) =>
                setNewPartner({ ...newPartner, intrest: v })
              }
              options={[
    ...
    <input
      type='input'
       ...
       onChange={(v) =>
                setNewPartner({ ...newPartner, refrence: v })
              }
